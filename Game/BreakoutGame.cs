...
class BreakoutGame : IGame
{
    ...
    readonly Texture texBackground = Engine.LoadTexture("hillsbg.png");
    readonly Texture texBall = Engine.LoadTexture("ball.png");

    // Load the font
    readonly Font font = Engine.LoadFont("arcade.ttf", 24);
    ...
    // bricks
    List<Brick> bricks;
    readonly float BrickWidth = 40;
    readonly float BrickHeight = 15;
    readonly int BrickSpacer = 10;
    // Score/track number of bricks hit
    int hitCount = 0;
    ...
    public void Update()
    {
        ...
        if (!ballLost)
        {
            ...
            ballPosition += direction * BallSpeed * Engine.TimeDelta;
